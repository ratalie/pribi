...
import type { TableConfig, TableCellRenderer, TableAction } from "~/types/tables/table-config";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
<template>
  ...
  >
    ...
    >
      ...
      <template v-if="(column.key === 'options' || column.key === 'edit-remove') && hasActions">
        <DropdownMenu>
