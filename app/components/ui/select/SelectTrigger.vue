  ...
  <SelectTrigger
    ...
    :class="
      cn(
        ...
        '!border-gray-500 focus-visible:!border-gray-700 focus-visible:!border-2 focus-visible:!outline-none focus-visible:!ring-2 focus-visible:!ring-purple-500 focus-visible:!ring-offset-4',
        props.class
      )
    "
  >
