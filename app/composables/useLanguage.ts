...
const translations = {
  es: {
    ...
    "config.appearanceDesc": "Personaliza el tema de la aplicación",
    ...
    "config.adminDashboard": "Dashboard de Administración",
    "config.adminDashboardDesc": "Configura el panel de administración",
    "config.dashboardSettings": "Configuración de Dashboard",
    "config.dashboardSettingsDesc": "Personaliza tu panel de control principal",
    "config.billing": "Facturación",
    "config.billingDesc": "Gestiona la facturación y pagos",
    "config.billingSettings": "Configuración de Facturación",
    "config.billingSettingsDesc": "Administra métodos de pago y planes",
    "config.users": "Usuarios",
    "config.usersDesc": "Administra usuarios del sistema",
    "config.userSettings": "Gestión de Usuarios",
    ...
    "config.generalSettingsDesc": "Ajustes básicos de la aplicación",
    "config.preferences": "Preferencias",
    "config.preferencesDesc": "Personaliza tu experiencia de usuario",
    "config.profile": "Perfil",
    "config.profileDesc": "Administra tu información personal",
    "config.profileSettings": "Configuración de Perfil",
    "config.profileSettingsDesc": "Actualiza tu información y preferencias",
    "config.gmail": "Gmail",
    ...
    "dashboard.funcionesMasUsadas": "Funciones más utilizadas",
