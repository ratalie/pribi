...
export const SUB_STEP_SECTIONS_MAP: Record<string, Array<Omit<SectionItem, "status">>> = {
  ...
  "nombramiento-directores": [
    ...
    },
    {
      ...
      description: "Establece la cantidad de directores del directorio",
      navigationType: "route",
    },
    {
      id: "votacion-cantidad",
      title: "Votación para la configuración del directorio",
      description: "Votación para aprobar la configuración del directorio",
      navigationType: "route",
    },
    {
      id: "nombramiento",
    ...
    },
    {
      ...
      description: "Registra la votación de designación",
      navigationType: "route",
    },
    {
      id: "presidente",
