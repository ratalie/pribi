  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        translationKey: "nav.planServicio",
        icon: "Package",
        href: "/features/plan-servicio",
        roles: ["admin"],
      },
      {
        id: "personalizacion",
        label: "Personalización",
        translationKey: "nav.personalizacion",
        icon: "Palette",
        href: "/features/personalizacion",
        roles: ["admin", "manager", "user"],
      },
      {
        id: "configuracion",
        label: "Configuración",
        translationKey: "nav.configuracion",
        icon: "Settings",
        href: "/features/configuracion",
        roles: ["admin", "manager"],
      },
      {
        id: "ayuda",
        label: "Ayuda",
        translationKey: "nav.ayuda",
        icon: "HelpCircle",
        href: "/features/ayuda",
        roles: ["admin", "manager", "user"],
      },
