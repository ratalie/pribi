...
/**
 * Store para el formulario de aporte
 * Similar a useAsignacionAccionesStore pero con campos adicionales
 */
export const useAportesStore = defineStore("aportesForm", {
  state: () => ({
    // Campos básicos
  ...
  actions: {
    ...
    getFormData() {
      return {
        ...
        comprobantePagoArchivoId: this.comprobantePagoArchivoId,
      };
    },
  },
});
