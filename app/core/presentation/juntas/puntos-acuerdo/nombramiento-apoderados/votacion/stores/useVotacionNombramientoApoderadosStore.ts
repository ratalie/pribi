...
/**
 * Store para gestionar Votaciones de Nombramiento de Apoderados
 *
 * ⚠️ IMPORTANTE: Usa Option API de Pinia (NO Composition API)
 * ✅ Soporta MÚLTIPLES items (una votación por cada apoderado a nombrar)
 */
export const useVotacionNombramientoApoderadosStore = defineStore(
  "votacionNombramientoApoderados",
  {
    state: () => ({
    ...
    getters: {
       ...
       *
       * @param puntoId - ID del punto de agenda (ej: "nombramiento-apoderados")
    ...
    actions: {
      ...
      async loadVotacion(societyId: number, flowId: number) {
        ...
        try {
          ...
          this.sesionVotacion = await useCase.execute(
            societyId,
            flowId,
            VoteContext.DESIGNACION_APODERADOS
          );

          // Si no hay sesión (404), es normal - se creará al guardar
          if (!this.sesionVotacion) {
            console.log(
              "[Store][VotacionNombramientoApoderados] No hay votación existente, se creará al guardar"
            );
          }
          ...
          if (error.statusCode === 404 || error.status === 404) {
            console.log(
              "[Store][VotacionNombramientoApoderados] No hay votación existente (404), se creará al guardar"
            );
          ...
          console.error("[Store][VotacionNombramientoApoderados] Error al cargar:", error);
          throw error;
        }
      },
      ...
      async addVote(
        ...
        try {
          ...
          await useCase.execute(societyId, flowId, VoteContext.DESIGNACION_APODERADOS, [
            {
              accion: "updateVote",
              itemId: item.id,
              votos: [
          ...
          console.error(
            "[Store][VotacionNombramientoApoderados] Error al agregar voto:",
            error
          );
          throw error;
        }
      ...
      async updateVote(
        ...
        try {
          ...
          console.error(
            "[Store][VotacionNombramientoApoderados] Error al actualizar voto:",
            error
          );
          throw error;
        }
      ...
      async addVoteItem(
        ...
        try {
          ...
          console.log(
            "[Store][VotacionNombramientoApoderados] Agregando item:",
          ...
          console.error(
            "[Store][VotacionNombramientoApoderados] Error al agregar item:",
            error
          );
          throw error;
        }
      ...
      async updateTipoAprobacion(
        ...
        try {
          ...
          console.error(
            "[Store][VotacionNombramientoApoderados] Error al actualizar tipo de aprobación:",
            error
          );
          throw error;
        }
      ...
      async createVotacion(
        ...
        try {
          ...
          console.log("[Store][VotacionNombramientoApoderados] Creando sesión con datos:", {
            sessionId: this.sesionVotacion.id,
            contexto: this.sesionVotacion.contexto,
          ...
          console.error("[Store][VotacionNombramientoApoderados] Error al crear:", error);
          throw error;
        }
      },
      ...
      async addVoteItemConVotos(
        ...
        try {
          ...
          console.log(
            "[Store][VotacionNombramientoApoderados] Agregando item con votos:",
            JSON.stringify(itemPayload, null, 2)
          );
          ...
          console.error(
            "[Store][VotacionNombramientoApoderados] Error al agregar item con votos:",
            error
          );
          throw error;
        }
      ...
      async updateItemConVotos(
        ...
        try {
          ...
          console.log(
            "[Store][VotacionNombramientoApoderados] Actualizando item con votos:",
            JSON.stringify(itemPayload, null, 2)
          );
          ...
          console.error(
            "[Store][VotacionNombramientoApoderados] Error al actualizar item con votos:",
            error
          );
          throw error;
        }
