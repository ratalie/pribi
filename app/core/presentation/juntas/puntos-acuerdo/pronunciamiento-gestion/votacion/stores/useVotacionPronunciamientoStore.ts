...
export const useVotacionPronunciamientoStore = defineStore("votacionPronunciamiento", {
  ...
  getters: {
    ...
    /**
     * Obtiene el item de votación (solo hay 1 para pronunciamiento)
     */
  ...
  actions: {
    ...
    async createVotacion(
      ...
      try {
        ...
        console.log("[Store][VotacionPronunciamiento] Creando sesión con datos:", {
        ...
        console.error("[Store][VotacionPronunciamiento] Error al crear:", error);
        throw error;
      }
    },
    ...
    async addVote(
      ...
      try {
        ...
        await useCase.execute(societyId, flowId, VoteContext.GESTION_SOCIAL, [
          {
            accion: "updateVote",
            itemId: item.id,
            votos: [
        ...
        console.error("[Store][VotacionPronunciamiento] Error al agregar voto:", error);
        throw error;
      }
    },
    ...
    async updateVote(
      ...
      try {
        ...
        console.error("[Store][VotacionPronunciamiento] Error al actualizar voto:", error);
        throw error;
      }
    },
