...
// Filtrar solo directores suplentes y alternos
const directoresSuplentesAlternos = computed(() => {
  return props.directores.filter(
  ...
  <div class="flex flex-col gap-4">
    <div>
      ...
      <p class="t-b2 text-gray-600 font-secondary">
        Identifica a los directores suplentes y alternos cuya remoción será evaluada.
      </p>
    </div>
    <CheckboxTable
      :columns="columns"
      :data="directoresSuplentesAlternos"
