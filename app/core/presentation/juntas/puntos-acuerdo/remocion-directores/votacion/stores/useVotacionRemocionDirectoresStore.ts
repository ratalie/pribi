...
/**
 * Store para gestionar Votaciones de Remoción de Directores
 *
 * ⚠️ IMPORTANTE: Usa Option API de Pinia (NO Composition API)
 * ✅ Soporta MÚLTIPLES items (una votación por cada director a remover)
 */
export const useVotacionRemocionDirectoresStore = defineStore("votacionRemocionDirectores", {
  state: () => ({
  ...
  getters: {
     ...
     *
     * @param puntoId - ID del punto de agenda (ej: "remocion-directores")
  ...
  actions: {
    ...
    async loadVotacion(societyId: number, flowId: number) {
      ...
      try {
        ...
        this.sesionVotacion = await useCase.execute(
          societyId,
          flowId,
          VoteContext.REMOCION_DIRECTORES
        );

        // Si no hay sesión (404), es normal - se creará al guardar
        if (!this.sesionVotacion) {
          console.log(
            "[Store][VotacionRemocionDirectores] No hay votación existente, se creará al guardar"
          );
        }
        ...
        if (error.statusCode === 404 || error.status === 404) {
          console.log(
            "[Store][VotacionRemocionDirectores] No hay votación existente (404), se creará al guardar"
          );
        ...
        console.error("[Store][VotacionRemocionDirectores] Error al cargar:", error);
        throw error;
      }
    },
    ...
    async addVote(
      ...
      try {
        ...
        await useCase.execute(societyId, flowId, VoteContext.REMOCION_DIRECTORES, [
          {
            accion: "updateVote",
            itemId: item.id,
            votos: [
        ...
        console.error("[Store][VotacionRemocionDirectores] Error al agregar voto:", error);
        throw error;
      }
    },
    ...
    async updateVote(
      ...
      try {
        ...
        console.error("[Store][VotacionRemocionDirectores] Error al actualizar voto:", error);
        throw error;
      }
    },
    ...
    async addVoteItem(
      ...
      try {
        ...
        console.log(
          "[Store][VotacionRemocionDirectores] Agregando item:",
        ...
        console.error("[Store][VotacionRemocionDirectores] Error al agregar item:", error);
        throw error;
      }
    },
    ...
    async updateTipoAprobacion(
      ...
      try {
        ...
        console.error(
          "[Store][VotacionRemocionDirectores] Error al actualizar tipo de aprobación:",
          error
        );
        throw error;
      }
    ...
    async createVotacion(
      ...
      try {
        ...
        console.log("[Store][VotacionRemocionDirectores] Creando sesión con datos:", {
        ...
        console.error("[Store][VotacionRemocionDirectores] Error al crear:", error);
        throw error;
      }
    },
    ...
    async addVoteItemConVotos(
      ...
      try {
        ...
        console.log(
          "[Store][VotacionRemocionDirectores] Agregando item con votos:",
          JSON.stringify(itemPayload, null, 2)
        );
        ...
        console.error(
          "[Store][VotacionRemocionDirectores] Error al agregar item con votos:",
          error
        );
        throw error;
      }
    ...
    async updateItemConVotos(
      ...
      try {
        ...
        console.log(
          "[Store][VotacionRemocionDirectores] Actualizando item con votos:",
          JSON.stringify(itemPayload, null, 2)
        );
        ...
        console.error(
          "[Store][VotacionRemocionDirectores] Error al actualizar item con votos:",
          error
        );
        throw error;
      }
