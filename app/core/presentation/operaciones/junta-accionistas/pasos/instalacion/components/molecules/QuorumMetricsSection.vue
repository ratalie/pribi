<template>
  <div class="flex flex-col gap-6 p-6 bg-white rounded-lg border border-gray-200">
    ...
    <div class="flex justify-between items-center">
      <span class="t-h5 font-primary font-bold text-gray-800">Acciones presentes</span>
    ...
    <div v-else class="flex flex-col gap-2">
      ...
      <div class="flex items-center gap-2">
        ...
        <span
          class="t-b1 font-secondary"
          :class="cumpleSimple ? 'text-green-700' : 'text-red-700'"
        >
      ...
      <div class="flex items-center gap-2">
        ...
        <span
          class="t-b1 font-secondary"
          :class="cumpleCalificado ? 'text-green-700' : 'text-red-700'"
        >
