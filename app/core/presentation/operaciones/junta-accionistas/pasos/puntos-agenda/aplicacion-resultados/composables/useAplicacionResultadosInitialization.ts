/**
 * Composable para inicializar y cargar datos de Aplicación de Resultados
 *
 * Responsabilidades:
...
export function useAplicacionResultadosInitialization() {
  ...
  const loadFromBackend = async (): Promise<void> => {
    ...
    try {
      ...
      console.error("[useAplicacionResultadosInitialization] Error al cargar datos:", error);
