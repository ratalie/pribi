 ...
 */
export const useVotacionAplicacionResultadosStore = defineStore(
  "votacionAplicacionResultados",
  {
    state: () => ({
    ...
    actions: {
      ...
      async loadVotacion(societyId: number, flowId: number) {
        ...
        try {
          ...
          this.sesionVotacion = await useCase.execute(
            societyId,
            flowId,
            VoteContext.APLICACION_UTILIDADES
          );
      ...
      async addVote(
        ...
        try {
          ...
          await useCase.execute(societyId, flowId, VoteContext.APLICACION_UTILIDADES, [
            {
              accion: "updateVote",
              itemId: item.id,
              votos: [
      ...
      async updateVote(
        ...
        try {
          ...
          console.error(
            "[Store][VotacionAplicacionResultados] Error al actualizar voto:",
            error
          );
          throw error;
        }
      ...
      async updateItemConVotos(
        ...
        try {
          ...
          console.log(
            "[Store][VotacionAplicacionResultados] Actualizando item con votos:",
          ...
          console.error(
            "[Store][VotacionAplicacionResultados] Error al actualizar item con votos:",
            error
          );
          throw error;
        }
