...
const initializeForm = () => {
  ...
  if (props.initialApoderado.persona.tipo === "JURIDICA") {
    ...
    personaNaturalStore.$patch({
        tipoDocumento: (persona.representadoPor.tipoDocumento as TipoDocumentosEnum) || "DNI",
...
const buildJuridicaPersona = () => {
  ...
  return {
    ...
    provincia: personaJuridicaStore.jurisdiccion === "peruana" ? personaJuridicaStore.provincia || undefined : undefined,
    distrito: personaJuridicaStore.jurisdiccion === "peruana" ? personaJuridicaStore.distrito || undefined : undefined,
    departamento:
      personaJuridicaStore.jurisdiccion === "peruana" ? personaJuridicaStore.departamento || undefined : undefined,
    pais:
...
<template>
  <BaseModal v-model="isOpen" size="lg" @close="handleClose" @submit="handleSubmit">
    <div class="flex flex-col gap-10">
      <CardTitle title="Gerente General" body="Registra al representante principal de la sociedad." />
