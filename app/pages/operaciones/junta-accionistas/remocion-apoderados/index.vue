  ...
  <div class="page-container p-6">
    ...
    <div class="placeholder mt-4">
      <p class="text-gray-600 dark:text-gray-300">
        ...
        <strong>Remoción de Apoderados</strong>
        . Aquí se configura la remoción o revocación de poderes otorgados.
      </p>
...
definePageMeta({
  ...
  // Ruta: /operaciones/junta-accionistas/remocion-apoderados
  // Enum: JuntaRoutes.REMOCION_APODERADOS
</script>
