<template>
  <SlotWrapper>
    <TitleH2
      title="Resumen: Capitalización de Créditos"
      subtitle="Revisa el resumen general del proceso de capitalización de créditos."
    />
      ...
      >
        <div class="flex flex-1 flex-col items-center justify-center w-full">
          ...
          >
            ...
            <span class="font-bold">Capitalización de Créditos.</span>
          </p>
        </div>
      </div>
    </section>
...
<script setup lang="ts">
  ...
  import { useLoadDataFlowCC } from "~/core/presentation/operaciones/junta-accionistas/pasos/puntos-agenda/aporte-dinerario/composables/useLoadDataFlowCC";

  /**
   * Página: Resumen de Capitalización de Créditos
   *
   * Vista específica del resumen dentro del punto de acuerdo "Capitalización de Créditos".
   *
   * Ruta: /operaciones/junta-accionistas/[id]/capitalizacion-creditos/resumen
   */
