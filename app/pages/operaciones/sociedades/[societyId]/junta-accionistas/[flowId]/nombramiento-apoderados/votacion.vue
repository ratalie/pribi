...
<script setup lang="ts">
  ...
  function getDescripcionItem(itemIndex: number): string {
    // ✅ Usar items filtrados del controller
    const itemsFiltrados = controller.itemsFiltrados;
    if (itemsFiltrados && typeof itemsFiltrados === "object" && "value" in itemsFiltrados) {
      const items = (itemsFiltrados as any).value;
