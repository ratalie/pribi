...
<script setup lang="ts">
  ...
  import { useVotacionRemocionDirectoresController } from "~/core/presentation/juntas/puntos-acuerdo/remocion-directores/votacion/composables/useVotacionRemocionDirectoresController";

  /**
   * Página: Votación (Sub-sección de Remoción de Directores)
   *
   * Sección dentro del sub-step "Remoción de Directores".
   * Se muestra en el sidebar derecho como sección navegable.
   *
   * Ruta: /operaciones/junta-accionistas/[id]/remocion-directores/votacion
   */
  ...
  const controller = useVotacionRemocionDirectoresController();
