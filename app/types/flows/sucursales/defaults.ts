/**
 * Default Values Helper - FlowItems Sucursales
 *
 * Provee valores por defecto para las interfaces de FlowItem
 * específicas del módulo de Sucursales.
 */

import type { FlowItemBehavior, FlowItemValidation } from "@/types/flow-system";

/**
 * Comportamiento por defecto de un FlowItem en Sucursales
 *
...
/**
 * Validación por defecto de un FlowItem en Sucursales
 *
