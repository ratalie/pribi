...
## ⚠️ IMPORTANTE: ENDPOINTS v1 vs v2

**🔴 CRÍTICO:** Los endpoints de capitalización de créditos están en **v1**, NO en v2.

### **Endpoints v1 (Acreedores y Capitalizaciones):**
...
### **Endpoints v2 (Agenda Items y Votaciones):**
...
**❌ NO uses rutas v2 para acreedores o capitalizaciones, solo existen en v1.**
...
**⚠️ IMPORTANTE:** Este endpoint está en **v1**, no en v2. Usa la ruta v1 como se muestra arriba.
...
1. **Endpoints v1 vs v2:**
   - ⚠️ **IMPORTANTE:** Los endpoints de acreedores y capitalizaciones **SOLO existen en v1**
   - ✅ Las votaciones están en **v2** con el contexto `CAPITALIZACION_DE_CREDITOS`
   - ✅ Los puntos de agenda están en **v2** con la ruta `/api/v2/society-profile/:societyId/assembly/:flowId/agenda-items`
   - 📝 En el futuro, los endpoints de acreedores y capitalizaciones se migrarán a v2 con UUIDs (similar a aporte dinerario)
   - 🔴 **NO uses rutas v2 para acreedores o capitalizaciones, solo existen en v1**

2. **IDs:**
   - ⚠️ En v1 se usan **números** (`id: number`) - **Esto es lo que debes usar actualmente**
   - ✅ En v2 se usarán **UUIDs** (`id: string`) - **Solo para votaciones y agenda items**
   - 📝 Por ahora, **DEBES usar los endpoints v1** para acreedores y capitalizaciones
