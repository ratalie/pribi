...
```json
{
  ...
  "archivoId": "019b3d90-aaaa-bbbb-cccc-1234567890ab"
}
```
- `archivoId` debe referenciar un documento previamente cargado.
- **Respuesta (`201`):** retorna `id` del poder.
...
```
*(estructura referencial, puede ampliarse con campos adicionales según handler)*
