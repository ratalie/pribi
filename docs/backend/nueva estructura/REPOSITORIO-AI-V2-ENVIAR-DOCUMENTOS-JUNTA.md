...
## 🎯 UBICACIÓN DE DOCUMENTOS DE JUNTA

**Path completo:** `/core/documentos-generados/operaciones/juntas-accionistas/{fecha-junta}/`
...
1. **Enviar documentos a una carpeta de junta específica** (ej: "junta 20 de Diciembre del 2024")
...
4. **La estructura completa se crea automáticamente** si no existe
...
3. **El path siempre será** `/core/documentos-generados/operaciones/juntas-accionistas/{nombre}/` independientemente del nombre que uses.
