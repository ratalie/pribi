---
title: SEO
source: https://i18n.nuxtjs.org/docs/guide/seo
author:
  - "[[@nuxtjs/i18n]]"
published:
created: 2025-10-15
...
[Read more about those features below](https://i18n.nuxtjs.org/docs/guide/#feature-details)
...
Check out the options you can pass to the `useLocaleHead()` in the [composable documentation](https://i18n.nuxtjs.org/docs/composables/use-locale-head#options)
...
- Canonical link  
	...
	[More on canonical](https://support.google.com/webmasters/answer/182192#dup-content)[Browser language detection](https://i18n.nuxtjs.org/docs/guide/browser-language-detection)
