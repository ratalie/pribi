---
title: Compatibility - Getting started
...
Vue, Svelte, and Astro support `<style>` blocks in component files that behave very much like [CSS modules](https://tailwindcss.com/docs/#css-modules), which means they are each processed by your build tooling totally separately and have all of the same drawbacks.
