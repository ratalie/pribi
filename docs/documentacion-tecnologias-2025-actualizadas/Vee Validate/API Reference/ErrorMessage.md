---
title: ErrorMessage
source: https://vee-validate.logaretm.com/v4/api/error-message/
author:
published:
created: 2025-10-21
...
[Edit This Page on GitHub](https://github.com/logaretm/vee-validate/edit/main/docs/src/pages/api/error-message.mdx)
