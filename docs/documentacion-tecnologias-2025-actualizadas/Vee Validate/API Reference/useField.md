---
title: useField
source: https://vee-validate.logaretm.com/v4/api/use-field/
author:
published:
created: 2025-10-21
...
```
jsconst { setValue } = useField('field', value => !!value);
...
A computed property that indicates if the field should be checked or unchecked, only available if `type=checkbox` or `type=radio` in field options. Useful if you are creating [custom checkboxes](https://vee-validate.logaretm.com/v4/examples/custom-checkboxes).
...
For more information on how you might use the `checked` property, check the [custom checkboxes example](https://vee-validate.logaretm.com/v4/examples/custom-checkboxes).
...
[Edit This Page on GitHub](https://github.com/logaretm/vee-validate/edit/main/docs/src/pages/api/use-field.mdx)
