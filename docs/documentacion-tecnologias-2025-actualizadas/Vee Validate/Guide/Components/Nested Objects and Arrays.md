...
source: https://vee-validate.logaretm.com/v4/guide/components/nested-objects-and-arrays/
author:
published:
created: 2025-10-21
...
```
vue<FieldArray name="users" v-slot="{ fields }">
...
[Read the API reference](https://vee-validate.logaretm.com/v4/api/field-array) for more information.
...
Since vee-validate supports [form-level validation](https://vee-validate.logaretm.com/v4/guide/components/validation#form-level-validation), referencing the nested fields may vary depending on how you are specifying the schema.
...
You can [visit this link](https://vee-validate.logaretm.com/v4/examples/array-fields) for a practical example using nested arrays.

## Next Step

[

Global Validators Defining global rules to be used throughout your web app

](https://vee-validate.logaretm.com/v4/guide/global-validators/)

[Edit This Page on GitHub](https://github.com/logaretm/vee-validate/edit/main/docs/src/pages/guide/components/nested-objects-and-arrays.mdx)
