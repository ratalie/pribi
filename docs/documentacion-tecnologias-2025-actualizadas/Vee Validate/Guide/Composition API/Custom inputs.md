---
title: Custom inputs
source: https://vee-validate.logaretm.com/v4/guide/composition-api/custom-inputs/
author:
published:
created: 2025-10-21
...
Then you can wrap your zod field schemas with `toTypedSchema` function. [More on that here](https://vee-validate.logaretm.com/v4/guide/composition-api/typed-schema).
...
Then you can wrap your valibot field schemas with `toTypedSchema` function. [More on that here](https://vee-validate.logaretm.com/v4/guide/composition-api/typed-schema).
...
You can find a more advanced example of checkboxes on [this page](https://vee-validate.logaretm.com/v4/examples/custom-checkboxes/).
...
Composable Helpers Access any field or form state within child components with these composable helpers.

](https://vee-validate.logaretm.com/v4/guide/composition-api/helpers/)

[Edit This Page on GitHub](https://github.com/logaretm/vee-validate/edit/main/docs/src/pages/guide/composition-api/custom-inputs.mdx)
