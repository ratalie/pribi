...
source: https://vee-validate.logaretm.com/v4/guide/composition-api/getting-started/
author:
published:
created: 2025-10-21
...
- [Global validators](https://vee-validate.logaretm.com/v4/guide/global-validators) (Laravel-like syntax) through `@vee-validate/rules`.
...
The package exposes a `toTypedSchema` function that you can use to wrap your yup schemas, this allows vee-validate to infer form input and output types. [More on that here](https://vee-validate.logaretm.com/v4/guide/composition-api/typed-schema).
...
Then you can wrap your zod schemas with `toTypedSchema` function which allows vee-validate to infer form input and output types. [More on that here](https://vee-validate.logaretm.com/v4/guide/composition-api/typed-schema).
...
Then you can wrap your Valibot schemas with `toTypedSchema` function which allows vee-validate to infer form input and output types. [More on that here](https://vee-validate.logaretm.com/v4/guide/composition-api/typed-schema).
...
You can refer to the full guide on global rules [here](https://vee-validate.logaretm.com/v4/guide/global-validators).
...
Both `zod` and `yup` are very good at defining schemas especially nested values so it is recommended that you use either. As an added bonus, you get full typescript support with either of them. You can refer to the [Typed schemas guide](https://vee-validate.logaretm.com/v4/guide/composition-api/typed-schema) to learn more about how to maximize the type safety of your schemas.
...
Handling forms Submissions, resets and form state

](https://vee-validate.logaretm.com/v4/guide/composition-api/handling-forms/)

[Edit This Page on GitHub](https://github.com/logaretm/vee-validate/edit/main/docs/src/pages/guide/composition-api/getting-started.mdx)
