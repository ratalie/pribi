...
source: https://vee-validate.logaretm.com/v4/integrations/zod-schema-validation/
author:
published:
created: 2025-10-21
...
You can also use Zod’s `zod.object` to create validation schemas for your forms instead of individually passing it for each field, this is covered in general in the [form-level validation section](https://vee-validate.logaretm.com/v4/guide/components/validation).
...
You can find more information on how typed schemas work in vee-validate [here](https://vee-validate.logaretm.com/v4/guide/composition-api/typed-schema#zod)
...
[Edit This Page on GitHub](https://github.com/logaretm/vee-validate/edit/main/docs/src/pages/integrations/zod-schema-validation.mdx)
