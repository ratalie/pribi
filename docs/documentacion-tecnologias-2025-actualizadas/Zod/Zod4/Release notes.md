...
Refer to the [`z.stringbool()` docs](https://zod.dev/api#stringbools) for more information.
...
Happy parsing!  
— Colin McDonnell [@colinhacks](https://x.com/colinhacks)[Migration guide](https://zod.dev/v4/changelog)
