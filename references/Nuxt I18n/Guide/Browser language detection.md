...
source: https://i18n.nuxtjs.org/docs/guide/browser-language-detection
author:
  - "[[@nuxtjs/i18n]]"
published:
created: 2025-10-15
...
```[Ignoring Localized Routes](https://i18n.nuxtjs.org/docs/guide/ignoring-localized-routes)
