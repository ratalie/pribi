...
source: https://i18n.nuxtjs.org/docs/guide/lazy-load-translations
author:
  - "[[@nuxtjs/i18n]]"
published:
created: 2025-10-15
...
If your function returns an object of locale messages, **you must define it in the `defineI18nLocale()` composable function**.About `defineI18nLocale()` details, see the [here](https://i18n.nuxtjs.org/docs/composables/define-i18n-locale).
...
As messages could be loaded from a remote API invoking the `loadLocaleMessages` function will always load messages, unnecessary loading can impact performance.[SEO](https://i18n.nuxtjs.org/docs/guide/seo)
