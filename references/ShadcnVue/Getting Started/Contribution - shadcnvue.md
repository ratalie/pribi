---
title: Contribution - shadcn/vue
source: https://www.shadcn-vue.com/docs/contribution.html
author:
published:
created: 2025-10-13
...
![](https://www.shadcn-vue.com/diagrams/structure-dark.svg) ![](https://www.shadcn-vue.com/diagrams/structure-light.svg)
...
8. **examples** - Holds all examples not part of `/docs`, like the [main page](https://www.shadcn-vue.com/).
...
bashpnpm dev
```
1. To run the `shadcn-vue` cli package:
```bash
bashpnpm dev:cli
```
...
[Reka UI](https://www.reka-ui.com/) hosts many low-level UI components that are used to build reusable components. There are many cases that you need to wrap `Reka UI` components.
...
[Edit this page on GitHub](https://github.com/unovue/shadcn-vue/tree/dev/apps/www/src/content/docs/contribution.md)