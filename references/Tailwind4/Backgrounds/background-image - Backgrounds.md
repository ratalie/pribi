---
title: background-image - Backgrounds
...
Use utilities like `bg-linear-to-r` and `bg-linear-<angle>` with the [color stop utilities](https://tailwindcss.com/docs/#setting-gradient-color-stops) to add a linear gradient to an element:
...
Use the `bg-radial` and `bg-radial-[<position>]` utilities with the [color stop utilities](https://tailwindcss.com/docs/#setting-gradient-color-stops) to add a radial gradient to an element:
...
Use the `bg-conic` and `bg-conic-<angle>` utilities with the [color stop utilities](https://tailwindcss.com/docs/#setting-gradient-color-stops) to add a conic gradient to an element:
...
Prefix a `background-image` utilitywith a breakpoint variant like `md:` to only apply the utility at mediumscreen sizes and above:
