---
title: Validation
source: https://vee-validate.logaretm.com/v4/guide/components/validation/
author:
published:
created: 2025-10-21
...
See the Pen [Basic Example](https://codepen.io/logaretm/pen/rNxbMzq) by Abdelrahman Awad ([@logaretm](https://codepen.io/logaretm)) on [CodePen](https://codepen.io/).
...
For more information on the `Field` component, read [the API reference](https://vee-validate.logaretm.com/v4/api/field).
...
For more information on the `Form` component, read [the API reference](https://vee-validate.logaretm.com/v4/api/form).

Yup Schema Optimizations

There are a couple of optimization caveats when it comes to using `yup` schemas to validate your forms, be sure to check the [best practices guide](https://vee-validate.logaretm.com/v4/guide/best-practices).

Zod Schema Plugin

There is an official integration available for [Zod validation](https://github.com/colinhacks/zod) that you can use as a drop-in replacement for `yup`. Check the [zod integration page](https://vee-validate.logaretm.com/v4/integrations/zod-schema-validation).
...
For 3rd party components you may consult their documentation to figure which events to trigger validation for. Here are a few examples for the common UI frameworks [here](https://vee-validate.logaretm.com/v4/examples/ui-libraries).
...
The `<ErrorMessage />` component is very flexible and you can customize its render output with scoped slots to build complex messages markup, read the [ErrorMessage API reference](https://vee-validate.logaretm.com/v4/api/error-message) for more information.
...
You can do this in two ways depending on which validators you are using (yup or [global validators](https://vee-validate.logaretm.com/v4/guide/global-validators)).
...
If you are interested in how to do the same for global validators check the [i18n guide](https://vee-validate.logaretm.com/v4/guide/i18n#custom-labels)
...
Handling Forms Handling form state and submissions

](https://vee-validate.logaretm.com/v4/guide/components/handling-forms/)

[Edit This Page on GitHub](https://github.com/logaretm/vee-validate/edit/main/docs/src/pages/guide/components/validation.mdx)
