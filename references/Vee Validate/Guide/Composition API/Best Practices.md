...
source: https://vee-validate.logaretm.com/v4/guide/best-practices/
author:
published:
created: 2025-10-21
...
```
jsimport { object, string } from 'yup';
...
[Edit This Page on GitHub](https://github.com/logaretm/vee-validate/edit/main/docs/src/pages/guide/best-practices.mdx)
