...
source: https://vee-validate.logaretm.com/v4/guide/composition-api/handling-forms/
author:
published:
created: 2025-10-21
...
If you are using `zod` or `yup` with [Typed schemas](https://vee-validate.logaretm.com/v4/guide/composition-api/typed-schema), you can define the initial values on the validation schema directly with `.default` instead of having to specify `initialValues`.

You can reset initial values at [any time using the `resetForm`](https://vee-validate.logaretm.com/v4/guide/composition-api/handling-forms/#handling-resets) function returned by `useForm`.
...
Nested Objects and Arrays Structuring form values in nested paths in objects or arrays

](https://vee-validate.logaretm.com/v4/guide/composition-api/nested-objects-and-arrays/)

[Edit This Page on GitHub](https://github.com/logaretm/vee-validate/edit/main/docs/src/pages/guide/composition-api/handling-forms.mdx)
