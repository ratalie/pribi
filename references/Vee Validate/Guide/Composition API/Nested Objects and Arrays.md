...
```
jsimport { useForm, useFieldArray } from 'vee-validate';
...
[Read the API reference](https://vee-validate.logaretm.com/v4/api/use-field-array) for more information.
...
Custom Inputs Building input components with the composition API

](https://vee-validate.logaretm.com/v4/guide/composition-api/custom-inputs/)

[Edit This Page on GitHub](https://github.com/logaretm/vee-validate/edit/main/docs/src/pages/guide/composition-api/nested-objects-and-arrays.mdx)
