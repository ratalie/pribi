...
For *branding* a schema. Refer to the [Branded types](https://zod.dev/api#branded-types) docs for more information.
...
Refer to the [Locales](https://zod.dev/error-customization#internationalization) docs for more on localization.[Zod](https://zod.dev/packages/zod)
