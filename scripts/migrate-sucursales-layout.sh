...
# Script para migrar todas las páginas de Sucursales al universal-flow-layout
# Fecha: 2025-11-03

PAGES_DIR="/home/yull23/nuxt/probo-v3/app/pages/registro-societario/sucursales"
LAYOUT_TO_ADD='universal-flow-layout'
COUNT=0
UPDATED=0
ADDED=0

echo "🚀 Iniciando migración de páginas de Sucursales a universal-flow-layout..."
echo ""
